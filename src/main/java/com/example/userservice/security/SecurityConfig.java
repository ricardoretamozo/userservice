...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/usuarios/**").hasAnyAuthority("ROLE_USER");
        http.authorizeRequests().antMatchers("/api/usuarios/save/**").hasAnyAuthority("ROLE_ADMIN");
